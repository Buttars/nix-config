...
base settings) into something you can actually use.

**Test:** _"What can this machine do?"_ — `programming`, `terminal-emulator`,
`hyprland`, `ai`, `cli`, `backup`, …

**Goes here:** aspects that group apps/base into a usable feature. A capability
...
**Dependencies:** may include `app/` and `base/` (one layer down) and other
